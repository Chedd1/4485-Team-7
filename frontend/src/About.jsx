...
const tweets = [
    {
        user: "Sarah Martinez", //not needed
        handle: "@sarahsafe", //not needed
        text: "Hurricane winds getting intense in New Orleans. Power just went out. Stay safe everyone! 🌀",
        time: "2:45 PM - Sep 15 2024",
        category: "Hurricane",
        stats: { likes: "5,579", retweets: "1,240", comments: "3,887" } //not needed
    },
    {
        user: "Michael Chen",
...
//helper to parse the time format - may need to change based on database
function parseTweetDate(timeStr) {
    // Example input: "2:45 PM - Sep 15 2024"
...
export default function Home() {
    ...
    ).slice().sort((a, b) => parseTweetDate(b.time) - parseTweetDate(a.time));
